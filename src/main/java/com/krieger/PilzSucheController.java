...
public class PilzSucheController {
    ...
    public static class PilzFeld{
        ...
        void nochEinmal(){
            ...
            wdh=scanner.nextLine().toLowerCase().charAt(0);
        }
        ...
        public void setSize(){
            //
            System.out.print("Spielfeld Größe eingeben: ");
